...
public class CreatingNewContactPage {
	...
	public void createNewContactWithOrg(String lastname,String orgname) {
		editlastname.sendKeys(lastname);
		orgbtn.click();
		wlib.SwitchToWindowWithPartialUrl(driver,"module=Accounts&action");
		editsearchtext.sendKeys(orgname);
		wlib.selectFromDropDown(searchdd, "Organization Name");
		searchbtn.click();
		driver.findElement(By.xpath("//a[text()='"+orgname+"']")).click();
		wlib.SwitchToWindowWithPartailTitle(driver,"Contacts");
		savebtn.click();
	}
